...
import {
  ...
  newAboutUsImageAdd,
} from "../controlers/sections/aboutUsImage.js";
import { adminRoute } from "../controlers/adminControler.js";
import { isAdmin, protect } from "../middleware/authMiddleware.js";
import multer from "multer";
import { newOurTeamImageAll } from "../controlers/sections/ourTeam.js";
...
router.put(
  "/aboutusimage/:mainId/:sectionId/:imageId",
  upload.single("img"),
  newAboutUsImageUpdate
);
router.delete("/aboutusimage/:_id", newAboutUsImageDelate);
router.put(
  "/aboutusimage/:mainId/:sectionId",
  upload.single("img"),
  newAboutUsImageAdd
);

router.get("/ourteam", newOurTeamImageAll);
